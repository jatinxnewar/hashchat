          ...
          <div className="p-6 overflow-y-auto">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h1 className="text-3xl font-bold text-primary-900 dark:text-gray-100">Starred Messages</h1>
                  <p className="text-primary-700 dark:text-gray-400">Important messages you've marked with a star</p>
                </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-primary-600 dark:text-gray-400">Total Starred</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-primary-200 dark:border-gray-700 dark:bg-gray-800">
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-primary-900 dark:text-gray-100">
                          {filteredMessages.filter((msg) => msg.importance === "high").length}
                        </p>
                        <p className="text-sm text-primary-600 dark:text-gray-400">High Priority</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-primary-600 dark:text-gray-400">From Groups</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-primary-500 dark:text-gray-500">
                              <div className="flex items-center space-x-1">
                                ...
                                <span>Starred: {formatDate(message.starredDate)}</span>
                              </div>
                              <div className="flex items-center space-x-1">
                                <Clock className="w-4 h-4" />
                                <span>Original: {formatDate(message.originalDate)}</span>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              {filteredMessages.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-primary-900 dark:text-gray-100 mb-2">No starred messages</h3>
